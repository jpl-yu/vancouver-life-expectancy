...
load("R:/working/preparing data/DeathData/cvdcausesicd9.RData")
...
deathsbyCauses9final<-deaths_icd9 %>% select(year, CT, sex, age, newcause3) %>% rename(cause=newcause3) %>% filter(cause=="stroke" | cause=="ischemic")


save(deathsbyCauses9final, file="R:/working/preparing data/DeathData/subsetcvd/icd9/deathsbyCausesICD9_final.RDATA")
