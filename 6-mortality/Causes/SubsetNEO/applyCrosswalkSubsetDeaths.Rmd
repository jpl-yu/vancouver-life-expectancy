...
## Select years of death and recode age variable
...
save(deaths, file="R:/working/preparing data/DeathData/causes/subset/deaths_cwapplied_subset.RData")
```
